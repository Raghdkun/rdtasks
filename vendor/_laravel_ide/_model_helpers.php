...
namespace App\Models {
    ...
    /**
     * App\Models\EmployeeClocking
     *
     * @property \Illuminate\Support\Carbon|null $deleted_at
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property mixed $notes
     * @property integer $daily_work_hours
     * @property \Illuminate\Support\Carbon $work_date
     * @property mixed $status
     * @property array|null $break_sessions
     * @property integer $total_break_minutes
     * @property integer $total_work_minutes
     * @property \Illuminate\Support\Carbon|null $clock_out_time
     * @property \Illuminate\Support\Carbon $clock_in_time
     * @property int $user_id
     * @property int $id
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereClockInTime($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereClockOutTime($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereTotalWorkMinutes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereTotalBreakMinutes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereBreakSessions($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereWorkDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereDailyWorkHours($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereNotes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereDeletedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking today()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking forUser()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking query()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking select(array|mixed $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking selectSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder|string $query, string $as)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking selectRaw(string $expression, array $bindings)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking fromSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder|string $query, string $as)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking fromRaw(string $expression, mixed $bindings)
     * @method static array createSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder|string $query)
     * @method static array parseSub(mixed $query)
     * @method static mixed prependDatabaseNameIfCrossDatabaseQuery(mixed $query)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking addSelect(array|mixed $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking distinct()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking from(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder|string $table, string|null $as)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking useIndex(string $index)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking forceIndex(string $index)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking ignoreIndex(string $index)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking join(string $table, \Closure|string $first, string|null $operator, string|null $second, string $type, bool $where)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking joinWhere(string $table, \Closure|string $first, string $operator, string $second, string $type)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking joinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder|string $query, string $as, \Closure|string $first, string|null $operator, string|null $second, string $type, bool $where)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking leftJoin(string $table, \Closure|string $first, string|null $operator, string|null $second)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking leftJoinWhere(string $table, \Closure|string $first, string $operator, string $second)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking leftJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder|string $query, string $as, \Closure|string $first, string|null $operator, string|null $second)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking rightJoin(string $table, \Closure|string $first, string|null $operator, string|null $second)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking rightJoinWhere(string $table, \Closure|string $first, string $operator, string $second)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking rightJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder|string $query, string $as, \Closure|string $first, string|null $operator, string|null $second)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking crossJoin(string $table, \Closure|string|null $first, string|null $operator, string|null $second)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking crossJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder|string $query, string $as)
     * @method static \Illuminate\Database\Query\JoinClause newJoinClause(\Illuminate\Database\Query\Builder $parentQuery, string $type, string $table)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking mergeWheres(array $wheres, array $bindings)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking where(\Closure|string|array $column, mixed $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking addArrayOfWheres(array $column, string $boolean, string $method)
     * @method static array prepareValueAndOperator(string $value, string $operator, bool $useDefault)
     * @method static bool invalidOperatorAndValue(string $operator, mixed $value)
     * @method static bool invalidOperator(string $operator)
     * @method static bool isBitwiseOperator(string $operator)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhere(\Closure|string|array $column, mixed $operator, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereNot(\Closure|string|array $column, mixed $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereNot(\Closure|string|array $column, mixed $operator, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereColumn(string|array $first, string|null $operator, string|null $second, string|null $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereColumn(string|array $first, string|null $operator, string|null $second)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereRaw(string $sql, mixed $bindings, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereRaw(string $sql, mixed $bindings)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereIn(string $column, mixed $values, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereIn(string $column, mixed $values)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereNotIn(string $column, mixed $values, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereNotIn(string $column, mixed $values)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereIntegerInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereIntegerInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereIntegerNotInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereIntegerNotInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereNull(string|array $columns, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereNull(string|array $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereNotNull(string|array $columns, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereBetween(string|\Illuminate\Database\Query\Expression $column, iterable $values, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereBetweenColumns(string $column, array $values, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereBetween(string $column, iterable $values)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereBetweenColumns(string $column, array $values)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereNotBetween(string $column, iterable $values, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereNotBetweenColumns(string $column, array $values, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereNotBetween(string $column, iterable $values)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereNotBetweenColumns(string $column, array $values)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereNotNull(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereDate(string $column, string $operator, \DateTimeInterface|string|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereDate(string $column, string $operator, \DateTimeInterface|string|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereTime(string $column, string $operator, \DateTimeInterface|string|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereTime(string $column, string $operator, \DateTimeInterface|string|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereDay(string $column, string $operator, \DateTimeInterface|string|int|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereDay(string $column, string $operator, \DateTimeInterface|string|int|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereMonth(string $column, string $operator, \DateTimeInterface|string|int|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereMonth(string $column, string $operator, \DateTimeInterface|string|int|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereYear(string $column, string $operator, \DateTimeInterface|string|int|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereYear(string $column, string $operator, \DateTimeInterface|string|int|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking addDateBasedWhere(string $type, string $column, string $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereNested(\Closure $callback, string $boolean)
     * @method static \Illuminate\Database\Query\Builder forNestedWhere()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking addNestedWhereQuery(\Illuminate\Database\Query\Builder $query, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereSub(string $column, string $operator, \Closure $callback, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereExists(\Closure $callback, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereExists(\Closure $callback, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereNotExists(\Closure $callback, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereNotExists(\Closure $callback)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking addWhereExistsQuery(\Illuminate\Database\Query\Builder $query, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereRowValues(array $columns, string $operator, array $values, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereRowValues(array $columns, string $operator, array $values)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereJsonContains(string $column, mixed $value, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereJsonContains(string $column, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereJsonDoesntContain(string $column, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereJsonDoesntContain(string $column, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereJsonContainsKey(string $column, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereJsonContainsKey(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereJsonDoesntContainKey(string $column, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereJsonDoesntContainKey(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereJsonLength(string $column, mixed $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereJsonLength(string $column, mixed $operator, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking dynamicWhere(string $method, array $parameters)
     * @method static void addDynamic(string $segment, string $connector, array $parameters, int $index)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking whereFullText(string|string[] $columns, string $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orWhereFullText(string|string[] $columns, string $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking groupBy(array|string ...$groups)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking groupByRaw(string $sql, array $bindings)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking having(\Closure|string $column, string|int|float|null $operator, string|int|float|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orHaving(\Closure|string $column, string|int|float|null $operator, string|int|float|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking havingNested(\Closure $callback, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking addNestedHavingQuery(\Illuminate\Database\Query\Builder $query, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking havingNull(string|array $columns, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orHavingNull(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking havingNotNull(string|array $columns, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orHavingNotNull(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking havingBetween(string $column, array $values, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking havingRaw(string $sql, array $bindings, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orHavingRaw(string $sql, array $bindings)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orderBy(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder|\Illuminate\Database\Query\Expression|string $column, string $direction)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orderByDesc(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder|\Illuminate\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking latest(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking oldest(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking inRandomOrder(string|int $seed)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking orderByRaw(string $sql, array $bindings)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking skip(int $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking offset(int $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking take(int $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking limit(int $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking forPage(int $page, int $perPage)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking forPageBeforeId(int $perPage, int|null $lastId, string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking forPageAfterId(int $perPage, int|null $lastId, string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking reorder(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Query\Expression|string|null $column, string $direction)
     * @method static array removeExistingOrdersFor(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking union(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder $query, bool $all)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking unionAll(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder $query)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking lock(string|bool $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking lockForUpdate()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking beforeQuery(callable $callback)
     * @method static void applyBeforeQueryCallbacks()
     * @method static string toSql()
     * @method static mixed find(int|string $id, array|string $columns)
     * @method static mixed findOr(mixed $id, \Closure|array|string $columns, \Closure|null $callback)
     ...
     * @method static int getCountForPagination(array $columns)
     * @method static array runPaginationCountQuery(array $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking cloneForPaginationCount()
     * @method static array withoutSelectAliases(array $columns)
     * @method static \Illuminate\Support\LazyCollection cursor()
     * @method static void enforceOrderBy()
     * @method static \Illuminate\Support\Collection pluck(string $column, string|null $key)
     ...
     * @method static mixed aggregate(string $function, array $columns)
     * @method static float|int numericAggregate(string $function, array $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking setAggregate(string $function, array $columns)
     * @method static mixed onceWithColumns(array $columns, callable $callback)
     * @method static bool insert(array $values)
     * @method static int insertOrIgnore(array $values)
     * @method static int insertGetId(array $values, string|null $sequence)
     ...
     * @method static array getBindings()
     * @method static array getRawBindings()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking setBindings(array $bindings, string $type)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking addBinding(mixed $value, string $type)
     * @method static mixed castBinding(mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking mergeBindings(\Illuminate\Database\Query\Builder $query)
     * @method static array cleanBindings(array $bindings)
     * @method static mixed flattenValue(mixed $value)
     * @method static string defaultKeyName()
     * @method static \Illuminate\Database\ConnectionInterface getConnection()
     * @method static \Illuminate\Database\Query\Processors\Processor getProcessor()
     * @method static \Illuminate\Database\Query\Grammars\Grammar getGrammar()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking useWritePdo()
     * @method static bool isQueryable(mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking clone()
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking cloneWithout(array $properties)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking cloneWithoutBindings(array $except)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking dump()
     * @method static void dd()
     * @method static bool chunk(int $count, callable $callback)
     * @method static \Illuminate\Support\Collection chunkMap(callable $callback, int $count)
     * @method static bool each(callable $callback, int $count)
     ...
     * @method static \Illuminate\Support\LazyCollection lazyByIdDesc(int $chunkSize, string|null $column, string|null $alias)
     * @method static \Illuminate\Support\LazyCollection orderedLazyById(int $chunkSize, string|null $column, string|null $alias, bool $descending)
     * @method static \Illuminate\Database\Eloquent\Model|EmployeeClocking|static|null first(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Model|EmployeeClocking|static|null sole(array|string $columns)
     * @method static \Illuminate\Contracts\Pagination\CursorPaginator paginateUsingCursor(int $perPage, array|string $columns, string $cursorName, \Illuminate\Pagination\Cursor|string|null $cursor)
     * @method static string getOriginalColumnNameForCursorPagination(\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder $builder, string $parameter)
     * @method static \Illuminate\Pagination\LengthAwarePaginator paginator(\Illuminate\Support\Collection $items, int $total, int $perPage, int $currentPage, array $options)
     * @method static \Illuminate\Pagination\Paginator simplePaginator(\Illuminate\Support\Collection $items, int $perPage, int $currentPage, array $options)
     * @method static \Illuminate\Pagination\CursorPaginator cursorPaginator(\Illuminate\Support\Collection $items, int $perPage, \Illuminate\Pagination\Cursor $cursor, array $options)
     * @method static \Illuminate\Database\Eloquent\Builder<EmployeeClocking>|EmployeeClocking tap(callable $callback)
     * @method static mixed when(callable|\TWhenParameter|null $value, callable|null $callback, callable|null $default)
     * @method static mixed unless(callable|\TUnlessParameter|null $value, callable|null $callback, callable|null $default)
     * @method static \Illuminate\Support\Collection explain()
     * @method static mixed forwardCallTo(mixed $object, string $method, array $parameters)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class EmployeeClocking extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property bool $is_on_break
     * @property int $total_break_duration
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<TimeEntry>|TimeEntry whereBreaks($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimeEntry>|TimeEntry whereTotalBreakDuration($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimeEntry>|TimeEntry whereIsOnBreak($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimeEntry>|TimeEntry whereBreakStartTime($value)
